    ...
    return (
      <label className="flex items-center min-w-0">
        <input
          ...
          className="bg-zinc-800 text-white border border-zinc-600 rounded px-2 py-1 text-sm min-w-[100px] max-w-[180px] focus:outline-none focus:ring-2 focus:ring-amber-500"
