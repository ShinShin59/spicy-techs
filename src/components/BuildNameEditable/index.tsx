...
const BuildNameEditable = () => {
    ...
    return (
      <label className="flex items-center min-w-0">
        <input
          ...
          className="bg-zinc-800 text-white border border-zinc-600  px-2 py-1 text-sm min-w-[100px] max-w-[180px] focus:outline-none focus:ring-2 focus:ring-amber-500"
  ...
  return (
    <div
      ...
      className="flex items-center gap-1.5 group cursor-pointer min-w-0  px-1 py-0.5 -m-0.5 hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-inset"
