...
const Topbar = ({ onNew, onFork }: TopbarProps) => {
  ...
  return (
    ...
    >
      ...
      {/* Logo – Shuffle animation, same look (Dune Rise, halo), hidden until font loads then fades in */}
      <LogoTitle />
    </header>
  )
}
